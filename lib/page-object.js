...
var PageObject = function(context, json, isArray, parentPath) {
    if(context && json) {
...
PageObject.prototype._readTree = function(json) {
    json = this._isArray ? json[0] : json;
...
PageObject.prototype._initObject = function() {
    ...
    if(this._isArray) {
        this._objects = function() {
            var objs = that._context.findElements(selector);
            that._createChildNodes(objs);
            return objs;
        }
    } else {
        this._object = function() {
            var obj = that._context.findElement(selector);
            ...
            (function (value) {
                ...
                elements.forEach(function(object) {
                    Object.defineProperty(object, child, {
                        get: function() {
                            return new PageObject(object, value, isArray, that._path);
                        }
                    });
                });
            })(this._childs[child]);
